...
//Hot Cross Buns
uint16_t NOTES_ARRAY1[] = {329.6276, 293.6648, 261.6256, 329.6276, 293.6648, 261.6256,
			   261.6256, 261.6256, 261.6256, 261.6256, 293.6648, 293.6648,
			   293.6648, 293.6648, 329.6276, 293.6648, 261.6256};
int BUTTONS_ARRAY1[] = {11, 9, 7, 11, 9, 7, 7, 7, 7, 7, 9, 9, 9, 9, 11, 9, 7};
char CHAR_ARRAY1[] = {'E', 'D', 'C', 'E', 'D', 'C', 'C', 'C', 'C', 'C', 'D',
		      'D', 'D', 'D', 'E', 'D', 'C'};

//Mary had a Little Lamb
uint16_t NOTES_ARRAY2[] = {329.6276, 293.6648, 261.6256, 293.6648, 329.6276,
		       ...
		       261.6276};
int BUTTONS_ARRAY2[] = {11, 9, 7, 9, 11, 11, 11, 9, 9, 9, 11, 14, 14, 11,
			9, 7, 9, 11, 11, 11, 11, 9, 9, 11, 9, 7};
char CHAR_ARRAY2[] = {'E', 'D', 'C', 'D', 'E', 'E', 'E', 'D', 'D', 'D', 'E',
		      'G', 'G', 'E', 'D', 'C', 'D', 'E', 'E', 'E', 'E', 'D',
		      'D', 'E', 'D', 'C'};

//Twinkle Twinkle
uint16_t NOTES_ARRAY3[] = {261.6256, 261.6256, 391.9954, 391.9954, 440, 440,
...
int  BUTTONS_ARRAY3[] = {7, 7, 14, 14, 16, 16, 14, 12, 12, 11, 11, 9, 9, 7,
			14, 14, 12, 12, 11, 11, 9, 14, 14, 12, 12, 11, 11,
			9, 7, 7, 14, 14, 16, 16, 14, 12, 12, 11, 11, 9,
			9, 7};
char CHAR_ARRAY3[] = {'C', 'C', 'G', 'G', 'A', 'A', 'G', 'F', 'F', 'E', 'E',
...
//Jingle Bells
uint16_t NOTES_ARRAY4[] = {329.6276, 329.6276, 329.6276, 329.6276, 329.6276, 329.6276,
			  ...
			  293.6648, 293.6648, 329.6276, 293.6648, 391.9954,
...
uint16_t NOTES_ARRAY6[] = {391.9954, 523.2511, 523.2511, 587.3295, 523.2511,
			  ...
			  493.8833, 523.2511, 391.9954, 523.2511, 523.2511,
...
//Happy Birthday
uint16_t NOTES_ARRAY7[] = {391.9954, 391.9954, 440, 391.9954, 523.2511, 493.8833,
			  ...
			  587.3295, 523.2511};
int BUTTONS_ARRAY7[] = {14, 14, 16, 14, 19, 18, 14, 14, 16, 14, 21, 19, 14, 14,
		       26, 23, 19, 18, 16, 24, 24, 23, 19, 21, 19};
char CHAR_ARRAY7[] = {'G', 'G', 'A', 'G', 'C', 'B', 'G', 'G', 'A', 'G', 'D', 'C',
